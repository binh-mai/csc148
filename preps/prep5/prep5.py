...
class LinkedList:
    ...
    def __contains__(self, item: Any) -> bool:
        ...
        if curr is None:
            ...
            while curr is not None:
                if curr.item == item: # comparing if the item in the Node == item
                    # (not curr == item because curr also contains reference to the
                    # next item)
                    return True
                else:
                    curr = curr.next
    ...
    def append(self, item: Any) -> None:
        ...
        if curr is None:
            ...
            while curr.next is not None: # using curr.next instead of curr means
                # that when the loop ends, curr will refer to the last Node
                # and not None!
                curr = curr.next
            curr.next = new_node
