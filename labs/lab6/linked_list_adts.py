...
class LinkedList:
    ...
    def pop(self, index: int) -> Any:
        ...
        if index == 0:
            current_curr = self._first.item
            self._first = self._first.next
            return current_curr

        else:
            curr = self._first
            while not (curr is None and curr_count == index - 1):
                curr = curr.next
                curr_count += 1
...
class LinkedListStack:
    ...
    def pop(self) -> Any:
        ...
        # Use the method pop in the LinkedList to write this! (self._items.pop(0))
