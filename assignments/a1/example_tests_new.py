...
def students() -> list[course.Student]:
    return [course.Student(1, 'Zoro'),
            ...
            course.Student(3, 'Hina'),
            course.Student(4, 'Yvette')]

@pytest.fixture
def students_empty() -> list[course.Student]:
    return [course.Student(1, ''),
            course.Student(2, '')]
...
################################################################################
class TestCourse:
    def test_enroll_students_invalid_ans(self, empty_course, students_empty) \
            -> None:
        empty_course.enroll_students(students_empty)
